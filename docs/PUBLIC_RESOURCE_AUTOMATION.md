...
공개 자료실에는 검색 결과 링크가 아니라 실제 공식 첨부파일이나 법령 원문만 들어간다. 현재 기준 검증선은 공개 자료 500건 이상, 지침 200건 이상, 서식 300건 이상, 직접 파일 450건 이상, 지침 내부 서식 추출 대기열 300건 이상이다. 이 기준을 통과하지 못하면 scheduled workflow가 실패한다.

직업계고 핵심 자료는 별도 보호선이 있다. 하이파이브 자료 40건 이상, 경북교육청 학교지원종합자료실 자료 300건 이상, 충북교육청 학교폭력·성폭력 예방 자료 20건 이상, 직업계고 현장실습 공통 매뉴얼, 편집 가능한 한글 서식·서식모음집이 빠지면 검증이 실패한다.
