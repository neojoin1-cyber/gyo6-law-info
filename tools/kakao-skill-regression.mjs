...
assert.match(indexSource, /firebase-config\.js\?v=20260620-bereavement-holiday-v1/);
assert.match(indexSource, /styles\.css\?v=20260620-bereavement-holiday-v1/);
...
assert.match(indexSource, /웹 법률정보 질문창이 사무실 Ollama 보강 경로까지 확인된 공식 이용 경로입니다/);
assert.match(indexSource, /웹 법률정보 질문창으로 이동/);
assert.match(indexSource, /auth\.js\?v=20260620-bereavement-holiday-v1/);
assert.match(indexSource, /policy-knowledge-base\.js\?v=20260620-bereavement-holiday-v1/);
assert.match(indexSource, /policy-engine\.js\?v=20260620-bereavement-holiday-v1/);
assert.match(indexSource, /app\.js\?v=20260620-bereavement-holiday-v1/);
