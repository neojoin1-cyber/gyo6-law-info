...
assert.match(indexSource, /firebase-config\.js\?v=20260620-remote-local-llm-v1/);
assert.match(indexSource, /styles\.css\?v=20260620-remote-local-llm-v1/);
...
assert.match(indexSource, /auth\.js\?v=20260620-remote-local-llm-v1/);
assert.match(indexSource, /policy-knowledge-base\.js\?v=20260620-remote-local-llm-v1/);
assert.match(indexSource, /policy-engine\.js\?v=20260620-remote-local-llm-v1/);
assert.match(indexSource, /app\.js\?v=20260620-remote-local-llm-v1/);
