...
assert.match(indexSource, /firebase-config\.js\?v=20260621-simple-law-v1/);
assert.match(indexSource, /styles\.css\?v=20260621-simple-law-v1/);
assert.match(indexSource, /법률정보 질문창/);
assert.match(indexSource, /대상 신분과 1차 업무영역을 먼저 정한 뒤 질문을 적으면/);
...
assert.match(indexSource, /대상 신분 <small>필수<\/small>/);
assert.match(indexSource, /1차 업무영역 <small>필수<\/small>/);
...
assert.match(indexSource, /auth\.js\?v=20260621-simple-law-v1/);
assert.match(indexSource, /policy-knowledge-base\.js\?v=20260621-simple-law-v1/);
assert.match(indexSource, /policy-engine\.js\?v=20260621-simple-law-v1/);
assert.match(indexSource, /app\.js\?v=20260621-simple-law-v1/);
