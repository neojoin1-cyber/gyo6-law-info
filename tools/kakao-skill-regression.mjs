...
assert.match(indexSource, /public-resource-index-generated\.js\?v=20260709-resource-harvest-v3/);
...
assert.match(indexSource, /styles\.css\?v=20260709-resource-harvest-v3/);
assert.match(indexSource, /app\.js\?v=20260709-resource-harvest-v3/);
