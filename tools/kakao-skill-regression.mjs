...
assert.match(indexSource, /public-resource-index-generated\.js\?v=20260709-resource-harvest-v2/);
...
assert.match(appSource, /function normalizePublicResourceExtraction/);
assert.match(appSource, /서식 추출 준비/);
...
assert.match(indexSource, /styles\.css\?v=20260709-resource-harvest-v2/);
assert.match(indexSource, /app\.js\?v=20260709-resource-harvest-v2/);
...
assert.match(stylesSource, /\.resource-extraction-chip/);
