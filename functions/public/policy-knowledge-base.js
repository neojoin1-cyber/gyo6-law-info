  ...
  return {
    ...
    staffAttendance: {
      ...
      publicTeacher: {
        ...
        childbirthLeave: {
          basis: ["국가공무원 복무규정 출산휴가 조항", "교원휴가에 관한 예규", "근로기준법 제74조"],
          normalDays: 90,
          multipleBirthDays: 120,
          postpartumMinDays: 45,
          multipleBirthPostpartumMinDays: 60,
          answer: "본인이 임신·출산한 경우 출산 전후를 통하여 90일, 한 번에 둘 이상 자녀를 임신한 경우 120일을 기준으로 봅니다.",
          postpartumRule: "출산 후 휴가 기간은 45일 이상, 한 번에 둘 이상 자녀를 임신한 경우 60일 이상이 되도록 배치하는 기준을 함께 봅니다.",
          approval: "나이스 근무상황에서 출산휴가 또는 특별휴가로 신청하고, 출산예정일·출산일 확인 자료와 학교장 승인 절차를 맞춥니다."
        },
        attendanceTime: {
      ...
      fixedTermTeacher: {
        ...
        childbirthLeave: {
          basis: ["근로기준법 제74조", "소속 교육청 계약제교원 운영 지침", "교원휴가에 관한 예규 준용 여부", "임용계약서"],
          answer: "기간제교사의 본인 출산휴가는 임의로 줄일 수 있는 근로계약 사항이 아니라, 근로기준법 제74조의 출산전후휴가 기준과 계약제교원 운영 지침을 함께 적용하는 사안입니다.",
          approval: "나이스 근무상황 또는 학교 복무 신청에서 출산휴가로 상신하고, 출산예정일·출산일 확인 자료와 학교장 승인 이력을 맞춥니다."
        },
        attendanceTime: {
