    ...
    staffAttendance: {
      ...
      publicTeacher: {
        ...
        sickLeave: {
          ...
          evidenceRule: "병가 일수가 연간 6일을 초과하면 의사의 진단서를 첨부해야 합니다.",
          approval: "나이스 근무상황에서 병가로 신청하고 진단서·입원확인서 등 증빙과 학교장 승인을 맞춰 처리합니다."
        },
        attendanceTime: {
      ...
      fixedTermTeacher: {
        ...
        sickLeave: {
          ...
          approval: "나이스 근무상황 또는 학교 내부 복무 신청으로 병가를 상신하고, 연간 6일 초과 병가 등은 진단서 기준을 확인합니다."
        },
        attendanceTime: {
      ...
      privateSchoolTeacher: {
        sickLeave: {
          ...
          evidenceRule: "교원휴가 기준을 준용하는 경우 병가 일수가 연간 6일을 초과하면 의사의 진단서를 첨부하는 기준을 함께 봅니다.",
          hourlyConversion: "교원휴가 기준을 준용하는 경우 질병·부상으로 인한 지각·조퇴·외출은 누계 8시간을 병가 1일로 계산합니다.",
          approval: "나이스 근무상황 또는 학교 내부 복무 신청으로 병가를 상신하고 학교법인 규정상 승인권자와 증빙 기준을 확인합니다."
        }
      }
    },
    domesticTravel: {
